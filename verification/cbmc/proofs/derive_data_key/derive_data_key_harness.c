...
void derive_data_key_harness() {
    ...
    save_byte_from_array(&session->header.alg_suite_data.buffer, &session->header.alg_suite_data.len, &old_byte_from_alg_suite_data);
    ...
    save_byte_from_array(&materials->unencrypted_data_key.buffer, &materials->unencrypted_data_key.len, &old_byte_from_unencrypted_data_key);
    ...
    assert_byte_buf_equivalence(&materials->unencrypted_data_key, old_unencrypted_data_key, &old_byte_from_unencrypted_data_key);
}
